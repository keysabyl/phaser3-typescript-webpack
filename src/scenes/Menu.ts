...
class Menu extends Phaser.Scene {
    ...
    create() {
        ...
        if (this.user == null) {
            ...
            this.registerElement.setPerspective(800); //not sure what this does but found more info at https://photonstorm.github.io/phaser3-docs/Phaser.GameObjects.DOMElement.html
